...
<footer className="bg-black dark:bg-white pt-2  ">
    <div className="mx-auto w-full max-w-screen-xl p-2 py-3 lg:py-4">
        <div className=" md:justify-between">
         
          <div className="grid grid-cols-1 gap-6 text-center md:grid-cols-3  md:gap-3 md:text-center ">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-white   dark:text-gray-400 uppercase">Resources</h2>
